...
from PIL import Image, ImageTk
path_to_model = r'C:\Fleetronix\ML\Batch 2\Detection of Retinal pigmentosa in paediatric age patients using CNN with Tkinter Framework\model\cnn_model.hdf5'
